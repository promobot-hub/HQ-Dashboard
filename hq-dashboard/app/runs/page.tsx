      ...
      <section className="rounded-3xl border border-[rgba(255,255,255,0.08)] bg-white/5 backdrop-blur-md shadow-[0_8px_32px_rgba(0,0,0,0.35)] p-6 md:p-8">
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-3">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
            ...
            <div className="text-emerald-300 text-xl font-extrabold">
              {stats.success}
            </div>
          </div>
          <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
            ...
            <div className="text-red-300 text-xl font-extrabold">
              {stats.fail}
            </div>
          </div>
        </div>
      ...
      <section className="rounded-3xl border border-[rgba(255,255,255,0.08)] bg-white/5 backdrop-blur-md shadow-[0_8px_32px_rgba(0,0,0,0.35)] p-6 md:p-8">
        ...
        <ol className="mt-3 space-y-2 max-h-[60vh] overflow-auto pr-1">
          ...
          {!loading && filtered.length === 0 && (
            <li className="text-white/60 text-sm">No runs found.</li>
          )}
          {filtered.map((x, i) => (
            <li
              key={i}
