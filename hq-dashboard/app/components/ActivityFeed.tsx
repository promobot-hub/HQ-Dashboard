    ...
    <section className="mt-6 rounded-3xl border border-[rgba(255,255,255,0.08)] bg-white/5 backdrop-blur-md shadow-[0_8px_32px_rgba(0,0,0,0.35)] p-6">
      ...
      <ol className="mt-4 space-y-2 text-sm max-h-[320px] overflow-auto pr-1">
        ...
        {items.map((x, i) => (
          <li
            key={i}
            className="rounded-xl border border-white/10 bg-white/5 px-3 py-2 flex items-center gap-3"
          >
            <span className="inline-flex h-6 w-6 items-center justify-center rounded-lg bg-accent-cyan/20 text-accent-cyan">
              ✓
            </span>
